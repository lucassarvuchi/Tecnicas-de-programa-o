...
{
    public class SalaService : Interfaces.ISalaService
    {
        private readonly Interfaces.ISalaRepository _salaRepository;

        public SalaService(Interfaces.ISalaRepository salaRepository)
        {
